...
public class ButtonBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( Editor_Model.Button.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_picture = 1;
    private static final int PROPERTY_price = 2;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", Editor_Model.Button.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_picture] = new PropertyDescriptor ( "picture", Editor_Model.Button.class, "getPicture", "setPicture" ); // NOI18N
            properties[PROPERTY_price] = new PropertyDescriptor ( "price", Editor_Model.Button.class, "getPrice", "setPrice" ); // NOI18N
        }
    ...
    private static final int METHOD_hasChanged4 = 4;
    private static final int METHOD_notifyObservers5 = 5;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_hasChanged4] = new MethodDescriptor(java.util.Observable.class.getMethod("hasChanged", new Class[] {})); // NOI18N
            methods[METHOD_hasChanged4].setDisplayName ( "" );
            methods[METHOD_notifyObservers5] = new MethodDescriptor(java.util.Observable.class.getMethod("notifyObservers", new Class[] {})); // NOI18N
            methods[METHOD_notifyObservers5].setDisplayName ( "" );
            methods[METHOD_notifyObservers6] = new MethodDescriptor(java.util.Observable.class.getMethod("notifyObservers", new Class[] {java.lang.Object.class})); // NOI18N
